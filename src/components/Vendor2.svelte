<script>
    ...
    let intervals1 = [
      { start: 0, end: 1.0155, color: "#e63946" },
      { start: 1.49, end: 2.57, color: "#457b9d" },
      { start: 3.01, end: 3.49, color: "#2a9d8f" }
    ];
  
    let intervals2 = [
      { start: 0, end: 0.97, color: "#e63946" },
      { start: 1.509, end: 2.507, color: "#457b9d" },
      { start: 3.03, end: 3.59, color: "#2a9d8f" }
    ];
